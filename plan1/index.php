			...
			<header>
				...
				<div class="wrapper">
					<div class="col">
						...
						<p class="pad_bot1"><strong>Sed ut perspiciatis unde omnis</strong> iste naterror voluptatem accusantium doareue laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore:</p>
...
<div class="body3">
	<div class="main">
		<section id="content2">
			...
			<article class="col4">
				<h4><span><span class="right"></span>Our Researches</span></h4>
				<div class="wrapper">
					<div class="pad">
						<ul class="list2">
			...
			<article class="col4">
				...
				<div class="wrapper">
					<div class="pad">
						...
						<p class="pad_bot3">
							Non provident, similique sunt in culpa qui officia deserunt mollitia animid laborum et dolorum fuga. Et harum quidem rerum facilis est et expedita distinctio.
						</p>
						<p>
							<a href="#">Nam libero tempore, cumoluta nobis est eligendi optio cumque</a>
						</p>
					</div>
				</div>
			</article>
